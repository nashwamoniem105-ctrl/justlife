...
*/
var F = /\[object (Boolean|Number|String|Function|Array|Date|RegExp)\]/,
    G = function(a) {
        var b;
        if (!(b = !a)) {
            var d;
            if (a == null) d = String(a);
                ...
                var c = F.exec(Object.prototype.toString.call(Object(a)));
    ...
    N = function(a, b) {
        ...
        for (var d = b.indexOf("\n\n"); d !== -1;) {
            var c = J,
                ...
                f;
            a: {
                let [l, u] = b.substring(0, d).split("\n");
                if (B(l, "event: message") && B(u, "data: ")) {
                    var g = u.substring(6);
                    try {
                        f = JSON.parse(g);
                        break a
...
function S(a, b) {
    ...
    if ((d = b.crypto) == null ? 0 : d.subtle) {
        if (Q.test(a)) return Promise.resolve(a);
        try {
            let c = R(a);
            return b.crypto.subtle.digest("SHA-256", c).then(e => T(e, b)).catch(() => "e2")
        } catch (c) {
...
var V = function(a, b) {
        ...
        if (b.strict) try {
            let c = new URL(a.g.location.href),
                e = new URL(d, c.origin);
            ...
            let f = c.pathname,
                ...
                l = g !== -1 ? f.substring(0, g) : "";
            l.endsWith("/") && (l = l.slice(0, -1));
            if (!(e.pathname.startsWith("/g/collect") || l && e.pathname.startsWith(l))) return {
                failureType: 18,
                command: 0,
            ...
            return {
                failureType: 12,
                command: 0,
                data: "Invalid command URL: " + c.message
            }
        }
    },
    X = function(a, b, d) {
    ...
    W = function(a, b, d) {
        return k(function*() {
            function c(h) {
                return k(function*() {
                    var [n, p] = h.split("|"), [z, v] = n.split("."), q = v, r = u[z];
                    r || (r = n, q = "");
                    var C = w => k(function*() {
                        try {
                            return yield da(p)(w)
                    ...
                    if (!q) {
                        if (typeof r === "string") return yield C(r);
                        let w = r,
                            A = Object.keys(w).map(K => k(function*() {
                                var ea = yield C(w[K]);
                                return `${K}=${ea}`
                            }()));
                        return (yield Promise.all(A)).join("&")
                    }
                    return typeof r === "object" && r[q] ? yield C(r[q]): h
                }())
            }
            ...
            function e(h) {
                return k(function*() {
                    for (var n,
                        ...
                        v.length !== 0 && (h = h.replace(D, q => v.shift() || q))
                    }
                    return h
                }())
            }
            var {
                ...
                if (h == null) return p => k(function*() {
                    return p
                }());
                var n = a.h[h];
                if (n == null) throw Error(`Unknown filter: ${h}`);
                return p => k(function*() {
                    return yield n(p, b)
                }())
            };
            ...
            } catch (h) {} else M && (t.referrer = M);
            y || (t.mode = "no-cors");
            l && (t.attributionReporting = P);
            try {
                let h = yield a.g.fetch(f, t);
                return t.mode === "no-cors" || h.ok ? {
                    data: y ? yield h.text(): f
                } : (d == null || d(), {
                    failureType: 9,
                    command: 0,
                    data: "Fetch failed"
...
var la = function(a, b) {
    class d {
        ...
        j(c, e) {
            var f = c.clientId;
            if (c.type === 0) c.stats = ja(this.i, f, Z(this.g)), e(c);
